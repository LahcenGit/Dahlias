                         ...
                         <form action="{{url('/dashboard-admin/courses')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="file"  class="form-control input-default @error('file') is-invalid @enderror" value="{{old('file')}}" name="file">
                                    @error('file')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text"  class="form-control input-default @error('youtub_link') is-invalid @enderror" value="{{old('youtub_link')}}" name="youtub_link">
                                    @error('youtub_link')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
